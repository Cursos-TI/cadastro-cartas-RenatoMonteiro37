...
// APRESENTAÇÃO DO SOFTWARE PARA O JOGADOR UTILIZANDO A FUNÇÃO PRINTF E \n para criar linhas.
    ...
    /*aqui utilizamos a formatação %s para o dado a ser captado pela função scanf e programamos para a variável jogador,
      dando assim o valor digitado pelo usuário atribuido a variável jogador.*/
    ...
    // CADASTRO DA CARTA 01
                  ...
                  scanf("%s", escolha);                                              /*aqui utilizei como artificio para parar o programa a função scanf,
                                                                                       de forma que o usuário possa ler com calma.*/
...
// ATÉ LOGO PARA O USUÁRIO APOS PREENCHER E CONFERIR SUAS CARTAS.
                  ...
                  scanf("%s", escolha);                                   /*aqui utilizei como artificio para parar o programa a função scanf,
                                                                de forma que o usuário possa ler com calma e esteja ao seu comando o encerramento do programa.*/

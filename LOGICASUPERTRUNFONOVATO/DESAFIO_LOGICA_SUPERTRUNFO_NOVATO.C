...
//  CADASTRO DA CARTA 02
                  ...
                  // declaração das variaveis para comparação.
                   ...
                   printf("\nMUITO BEM AGORA IREMOS ESCOLHER DE FORMA ALEATORIA UM ATRIBUTO PARA A COMPARACAO\n"); // Aqui começamos a fazer as decisoes para o if e else.


                   printf("\nO ATRIBUTO ESCOLHIDO FOI A DENSIDADE POPULACIONAL, ENTAO SAIBA QUE A CARTE QUE TIVER O MENOR VALOR NESSE CASO VENCE!!!\n");


                   printf("\nDENSIDADE POPULACIONAL CARTA 1: %.2f hab/km^2\nDENSIDADE POPULACIONAL CARTA 2: %.2f hab/km^2\n", densidade1, densidade2);
                

                   // aqui temos a comparacao dos atributos escolhidos e os caminhos para if atributo 1 vence para else atributo 2 vence.

...
//  CADASTRO DA CARTA 02
                  ...
                  printf("\nMEUS PARABENS VOCE CONCLUIU COM SUCESSO O CADASTRO DAS CARTAS, AGORA VAMOS COMPARAR OS PODERES DAS CARTAS! %s.\n", jogador);
                  ...
                  printf("\nCARTA 1 SUPERPODER:%.2f\n", SUPERPODER1);

                  printf("\nCARTA 2 SUPERPODER:%.2f\n", SUPERPODER2);


                 // printf("\n--- PERFEITO CHEGOU A HORA DE COMPARAR AS CARTAS LADO A LADO ---\n");
                  printf("\n--- PRESSIONE S E APERTE O ENTER PARA PROSSEGUIR ---\n");
                  scanf("%s", escolha);
                 ...
                 //  printf("--SUPERPODER:------%i------VS------%i-----.\n", comp_superpoder1, comp_superpoder2);
                   ...
                   printf("\nMUITO BEM AGORA ESCOLHA UM DOS ATRIBUTOS PARA A SUA JOGADA!\n");
                   printf("\n1. POPULACAO\n");             
                   printf("2. AREA\n");
                   printf("3. PIB\n");
                   ...
                   printf("\nDIGITE O NUMERO E APERTE ENTER PARA ESCOLHER O ATRIBUTO DA SUA JOGADA:  ");
                   ...
                   printf("\nVAMOS VER OS VALORES DOS ATRIBUTOS ESCOLHIDOS:\n");

                          if (escolha_atributo == 1) {
                            printf("\nPOPULACAO CARTA 1: %lu\n", populacao1);
                            printf("POPULACAO CARTA 2: %lu\n", populacao2);
                          } else if (escolha_atributo == 2) {
                            printf("\nAREA CARTA 1: %.2f KM^2\n", area1);
                            printf("AREA CARTA 2: %.2f KM^2\n", area2);
                          } else if (escolha_atributo == 3) {
                            printf("\nPIB CARTA 1: %.3f BILHOES DE REAIS\n", pib1);
                            printf("PIB CARTA 2: %.3f BILHOES DE REAIS\n", pib2);
                          } else if (escolha_atributo == 4) {
                            printf("\nPONTOS TURISTICOS CARTA 1: %i\n", pontosturisticos1);
                            printf("PONTOS TURISTICOS CARTA 2: %i\n", pontosturisticos2);
                          } else if (escolha_atributo == 5) {
                            printf("\nDENSIDADE POPULACIONAL CARTA 1: %.2f hab/km^2\n", densidade1);
                            printf("DENSIDADE POPULACIONAL CARTA 2: %.2f hab/km^2\n", densidade2);
                          }

                   // aqui temos o encerramento do programa.         
